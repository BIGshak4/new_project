...
**Last updated:** 2026-09-22 (mock interview §5j) · **Tests:** 656 offline + 17 live + `scripts/smoke_http.py` against Render · **Latest commit:** see changelog
...
Verification: 656 offline tests (was 631 → 656 with 12 interview tests and protection tests for 7 new routes), tsc clean, 33 web tests, `next build` passes, real-model dry runs for both flows.
