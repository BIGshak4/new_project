...
- Attempt setup appears before the long question body. Hint and solution buttons appear near the question title, including disabled controls with an explanation in preview mode. Hints and reference solutions remain separate, explicit exposure actions.
